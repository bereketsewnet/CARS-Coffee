...
export const translations: Record<Lang, Translations> = {
  en: {
    ...
    gallery: {
      ...
      title1: "CARES",
      title2: "Gallery",
      desc: "Visual documentation of field research, Laboratory research, telemetry captures, and circular economy implementation across the Ethiopian coffee supply chain architecture.",
      records: "RECORDS",
  ...
  am: {
    ...
    coordinators: {
      heroSub: "CTBE-አስተባባሪዎች",
      heroTitle1: "የእኛ",
      heroTitle2: "CTBE-አስተባባሪዎች",
