...
const DEFAULTS = [
  ...
  { page: "collaborations", tag: "CTBE-Coordinations", title: "Our CTBE-Coordinations",        subtitle: "Government officials, sponsors, civil society partners, and supporters who make the CARES mission possible." },
