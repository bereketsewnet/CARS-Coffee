...
export default function Collaborations({ collaborators, heading }: { collaborators: Collaborator[] | null; heading?: HeadingProp }) {
  const { t } = useLanguage();
    ...
    <div className="min-h-screen pt-24">
      ...
      <section className="py-20 bg-charcoal-mid relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <span className="tag-pill mb-4 inline-block">{heading?.tag ?? t.coordinators.heroSub}</span>
          <h1 className="font-serif text-5xl md:text-6xl font-bold mb-4">
            {heading ? heading.title : <span className="text-gradient-green">{t.coordinators.heroTitle2}</span>}
          </h1>
          <p className="text-muted-foreground text-lg max-w-2xl">
            {heading?.subtitle ?? t.coordinators.heroDesc}
          </p>
        </div>
      </section>
